        ...
        <div className="rule-container">
            ...
            <div className="rule-container-category">
                ...
                <BulletPoints
                    ...
                    content={[
                        "В чатах <c>#ваши-прицелы</c>, <c>#для-команд</c>, <c>#мемы</c> нарушения выдаем без словесного предупреждения, исключением являются те участники, которые находятся на сервере давно (от роли <r>«Энергичный»</r>).",
